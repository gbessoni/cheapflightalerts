    ...
    return (
      ...
      <Layout title="Welcome">
        ...
        <section className="section welcome-welcome">
          ...
          <div className="heading-tertiary text-center">
            <h3>
              But wait... If you want to receive <b>ALL our exclusive deals</b> from your favorite airports (only 1 airport allowed with free membership), add destinations and desired travel dates, plus get domestic flight deals. <b>Upgrade</b> for one year and receive <b>50% off</b> our normal price!
            </h3>
          </div>
        ...
        <div className="section welcome-promo">
